...
RUST_SERVER_CUSTOMMAP_ENABLED (DEFAULT "0" - Set to 1 to enable the custom map usage, WORLDSIZE and SEED are ignored then)
RUST_SERVER_LEVEL_URL (DEFAULT "" - the remote or local url to the custom map)
